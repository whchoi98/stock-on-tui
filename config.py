...
# KR Market Indices (yfinance symbols)
KR_INDICES = {
    "^KS11": "KOSPI",
    "^KQ11": "KOSDAQ",
}
...
# Economic Indicators (yfinance symbols)
INDICATORS = {
    "CL=F": ("WTI Oil", "$"),
    "GC=F": ("Gold", "$"),
    "SI=F": ("Silver", "$"),
...
# Sector → Related Economic Indicators mapping
# Maps stock sectors to relevant indicator symbols from INDICATORS
